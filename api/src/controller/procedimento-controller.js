...
class ProcedimentoController {
  ...
  async create(req, res) {
    ...
    const procedimento = await ProcedimentoModel.create({ nomeprocedimento, data, descricao, policial, gestor_id });
  ...
  async update(req, res) {
    ...
    ProcedimentoModel.update({
      nomeprocedimento, data, descricao, policial, gestor_id
    },
      {
        where: { id }
